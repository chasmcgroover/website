...
import {setup_load, login_logout,escape_text, login, setup_variables} from "../../../functions/baseFunc"
import { useEffect, useState } from "react"
import {loadUser, load_puzzles, update_loggedin} from "../../../functions/listPuzzles"
...
export default function Home() {
  ...
  useEffect(()=>{
    ...
    load_puzzles(false,setLoaded, setFinal)
  },[])
  ...
  return (
          ...
          <button className={`navbar-toggler ${isCollapsed ? 'collapsed' : ''}`} type="button" onClick={toggleNavbar}>
            ...
            <ul className="navbar-nav mr-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <Link className="nav-link active" aria-current="page" href="/top">
      ...
      >
        {user ? <></>:
          <form className="row g-2" id="formMustLogin" action="">
      ...
      >
        ...
        {loaded && final.length != 0? <></>:<span id="noPuzzles">
          Hunts are loading or there are currently no unsolved hunts. Please wait a
          few moments for hunts to load.
        </span>}
        <div
